    ...
    <form action="" id="update_status">
        ...
        <div class="form-group">
            ...
            <select name="status" id="status" class="form-control rounded-0" required>
                ...
                <option <?= isset($status) && $status == 3 ? 'selected' : '' ?> value="2">Out for Delivery</option>
                <option <?= isset($status) && $status == 4 ? 'selected' : '' ?> value="3">Delivered</option>
                <option <?= isset($status) && $status == 5 ? 'selected' : '' ?> value="4">Cancelled</option>
            </select>
        </div>
    </form>
</div>
